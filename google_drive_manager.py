...
class GoogleDriveManager:
  ...
  def write_json_to_drive(self, data, sub_folder_name, file_name):
    ...
    sub_folder_id = self.get_folder_id(
        f'Projects/MovieReviews/{sub_folder_name}')
    ...
    try:
      ...
      print(
          f'An error occurred while saving "{file_name}" to Google Drive: {e}')
    finally:
      if temp_file_path:
  ...
  def delete_file(self, file_id):
    try:
      ...
      print(
          f'File with ID "{file_id}" deleted successfully from Google Drive.')
    except Exception as e:
  ...
  def delete_folder_and_contents(self, folder_id):
    try:
      ...
      files = self.drive_service.files().list(q=f"'{folder_id}' in parents",
                                              fields="files(id)").execute()
      ...
      print(
          f'Folder with ID "{folder_id}" and its contents deleted successfully from Google Drive.'
      )
    except Exception as e:
      print(f'An error occurred: {e}')
