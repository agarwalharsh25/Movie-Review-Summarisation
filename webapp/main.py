...
async def get_movies(request: Request):
    ...
    for movie in movies:
        ...
        try:
            ...
            movie_obj = movie
            movie_obj["json_data"] = json.dumps({"details": movie, "review": movie_review})
    ...
    movie_data = sorted(movie_data, key=lambda x: datetime.strptime(x['release_date'], '%Y-%m-%d'), reverse=True)
